...
| **Casos y fotografías viajan apenas hay conexión** | La prueba de campo mostró que el botón no protegía al voluntario: le dejaba otra tarea y podía retener en el celular la evidencia del daño. Al abrir la aplicación, recuperar señal o guardar mientras ya hay conexión, salen primero los casos y después las fotografías, sin distinguir wifi de datos móviles. Antes de enviarlas se informa cuánto pesan. Con el ahorro de datos activo no se manda nada sin pedirlo, y nunca hay envío en segundo plano con la aplicación cerrada. |

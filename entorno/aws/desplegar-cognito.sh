...
echo ""
echo "    RECUERDE: crear un usuario SOLO en Cognito no le da fila en 'perfiles', y"
echo "    entonces el ingreso falla con 'su cuenta existe pero todavia no tiene perfil"
echo "    asignado'. El alta completa se hace por la API: POST /voluntarios."
